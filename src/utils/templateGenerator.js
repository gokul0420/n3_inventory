...
export const TEMPLATES = {
  stock_upload: {
    ...
    columns: [
      { header: 'Stock Code', key: 'Stock Code', width: 14, required: true, description: 'Unique stock code (e.g., STK-NEW). Must not already exist in the system.', example: 'STK-NEW1' },
      { header: 'Stock Name', key: 'Stock Name', width: 30, required: true, description: 'Full descriptive name of the stock item.', example: 'Laptop Dell Latitude 5540' },
      { header: 'Category', key: 'Category', width: 18, required: true, description: 'Item category. Must be one of: Electronics, Furniture, Stationery, Safety Equipment, Cleaning Supplies, IT Hardware.', example: 'Electronics' },
      { header: 'Location', key: 'Location', width: 22, required: false, description: 'Storage location. Options: Warehouse A, Warehouse B, Branch Office Delhi, Branch Office Mumbai, HQ Store. Defaults to "Warehouse A" if empty.', example: 'Warehouse A' },
      ...
      { header: 'Threshold', key: 'Threshold', width: 12, required: false, description: 'Low-stock alert threshold. Defaults to 10 if empty.', example: '10' },
      { header: 'Unit', key: 'Unit', width: 12, required: false, description: 'Unit of measurement (e.g., Units, Reams, Bottles, Cartridges). Defaults to "Units" if empty.', example: 'Units' },
    ],
    sampleRows: [
      ['STK-NEW1', 'Laptop Dell Latitude 5540', 'Electronics', 'Warehouse A', 100, 10, 'Units'],
      ['STK-NEW2', 'Office Chair Ergonomic Pro', 'Furniture', 'Warehouse B', 25, 5, 'Units'],
      ['STK-NEW3', 'A4 Paper (80 GSM)', 'Stationery', 'HQ Store', 500, 50, 'Reams'],
    ],
  },
